...
// console.log(doc)
// // doc.classList.add('wrap');
// // doc.classList.add('collapse');
// // doc.classList.add('alpha');
// // doc.classList.add('beta');
// //........................................
...
// let cloneNode = doc.cloneNode(true);
// cloneNode.style.backgroundColor='red';
...
//     blok.innerText=`${element.title}, ${element.monthDuration}`
...
// let skript=document.createElement('div');
// document.body.appendChild(skript);
// skript.classList.add('item');
...
//
//     elemh1.innerText=`${element.title}`;
//     elemp.innerText=`${element.monthDuration}`;
//     skript.append(elemh1,elemp);
// }
...
//     h2.innerText=item.surname;
//     a.innerText=item.age;
//     i.innerText=item.info;
//     img.src=item.photo;
//     // img.setAttribute('src',item.photo,img);
// div.append(h1,h2,a,i,img);
...
for (const item of coursesArray) {
    ...
    part.append(month, hour);
    section.append(h1, part, ul);
